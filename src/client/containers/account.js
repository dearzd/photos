...
class Account extends Component {
  ...
  getLandingBody() {
    ...
    switch (this.state.action) {
      case 'changeUserName':
        return <ChangeUserName changeUserName={changeUserName} history={history} userProfile={userProfile} onCancel={this.switchAction.bind(this, '')} />;
      case 'changeAvatar':
        return <ChangeAvatar changeAvatar={changeAvatar} history={history} userProfile={userProfile} onCancel={this.switchAction.bind(this, '')} />;
      case 'changePassword':
        return <ChangePassword changePassword={changePassword} history={history} userProfile={userProfile} onCancel={this.switchAction.bind(this, '')} />;
      default:
        return (

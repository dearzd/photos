            ...
            <div className="setting-body">
              ...
              <div>
                ...
                <div className="setting-item">
                  <div>
                    Login & Settings Bg
                    <Toggle open={landingBg && landingBg.enable} className="setting-toggle" onChange={this.handleBgToggle} />
                  </div>
                  {
                    landingBg && landingBg.enable ?
                      <div className="landing-buttons" style={{textAlign: 'center'}}>
                        <Button type="file" icon="add" text="Select Photo" className="btn-landing"  onChange={this.handlePhotoSelected} />
